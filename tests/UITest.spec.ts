...
//     let logo: any;
//     logo = await page.locator('img[alt="Website for automation practice"]');
...
//         let product1: any;
//         product1 = await page.locator('.single-products').first();
...
//         let product2: any;
//         product2 = await page.locator('.single-products').nth(1);
...
//         let productFirst: any; 
//         productFirst = await page.locator('.productinfo.text-center p').first().textContent();
//         await page.locator('a[href="/product_details/1"]').click();
...
//         let product1: any;
//         product1 = await page.locator('.single-products').first();
//         let product1Name: any;
//         product1Name = await page.locator('.productinfo.text-center p').first().textContent();
//         await product1.hover();
//         await product1.getByText('Add to cart').nth(1).click();
...
//         // Add products to cart
//         let product: any;
//         product = await page.locator('.single-products').first();
...
//         let productName: any;
//         productName = await product.locator('.productinfo.text-center p').textContent();
//         await product.hover();
